            ...
            <form method="POST">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" name="phone" aria-describedby="phone"
                           <#if user.phone??>value="${user.phone}"</#if>>
                </div>
                ...
                <div class="input-group mt-2">
                    ...
                    <textarea class="area regular form-control" name="bio" rows="3"
                              maxlength="300"><#if user.bio??>${user.bio?replace("<br>", "\r\n")}</#if></textarea>
                </div>
                        ...
                        <div class="input-group d-inline-flex mb-2 w-100" id="project-${userProject?counter}">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control right-border-none"
                                       name="name-project-${userProject?counter}"
                                       placeholder="<@s.message 'resume.project.name'/>" value="${userProject.name}"
                                       aria-describedby="project-1">
                                <input type="text" class="form-control" name="link-project-${userProject?counter}"
                                       placeholder="<@s.message 'resume.project.link'/>" value="${userProject.link}"
                                       aria-describedby="project-1">

                                <button type="button" onclick="removeList(this, 'project-')"
                                        class="btn btn-icon ml-2 d-flex justify-content-center align-items-center"><i
                                            class="fas fa-times"></i></button>
                            </div>
                        </div>
                ...
                <div class="input-group d-inline-flex mb-2 w-100" id="project-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control right-border-none" name="name-project-1"
                               placeholder="<@s.message 'resume.project.name'/>" aria-describedby="project-1">
                        <input type="text" class="form-control" name="link-project-1"
                               placeholder="<@s.message 'resume.project.link'/>" aria-describedby="project-1">
                ...
                <button type="button" id="project-adder"
                        class="btn btn-light w-100"><@s.message 'resume.project.button'/></button>
