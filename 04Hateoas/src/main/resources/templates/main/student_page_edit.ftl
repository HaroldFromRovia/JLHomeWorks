        ...
        <div class="card">
            ...
            <form method="POST" action="/user/${user.id}/edit">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" name="middleName" aria-describedby="middle-name"
                           <#if user.middleName??>value="${user.middleName}"</#if> required>
                </div>
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="date" class="form-control" name="birth" aria-describedby="birth"
                           <#if user.birthday??>value="${user.birthday?string['yyyy-MM-dd']}"</#if> required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="number" min="1970" class="form-control" name="yearStart" aria-describedby="year-start"
                           <#if user.yearStart??>value="${user.yearStart?c}"</#if>
                           placeholder="<@s.message 'sign.up.student.year.placeholder'/>" required>
                </div>

                <div class="input-group mt-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text"
                              id="year-graduate"><@s.message 'sign.up.student.year.graduate'/></span>
                    </div>
                    <input type="number" min="1973" class="form-control" name="yearGraduate"
                           aria-describedby="year-graduate"
                           <#if user.yearGraduate??>value="${user.yearGraduate?c}"</#if>
                           placeholder="<@s.message 'sign.up.student.year.placeholder'/>" required>
                </div>
                ...
                <div class="input-group mt-2">
                    ...
                    <input type="text" class="form-control" name="group" <#if user.group??>value="${user.group}"</#if>
                           aria-describedby="group" required>
                </div>
                ...
                <div class="input-group mt-2">
                    ...
                    <input type="text" class="form-control" name="average"
                           <#if user.average??>value="${user.average}"</#if> aria-describedby="average">
                </div>
